...
{
     public class SysAdminServices : ISysAdminServices
    {
        public readonly ISysAdminRepository _sysadminRepository;

        public SysAdminServices(ISysAdminRepository sysadminRepository)
        {
